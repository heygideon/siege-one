...
const cursorUpgrades: Upgrade[] = [
  {
    ...
    activeDescription: "+0.1 coins/sec",
    cost: 20,
    tick: (v: number) => v + 0.1,
  },
  {
    ...
    activeDescription: "+0.2 coins/sec",
    cost: 25,
    tick: (v: number) => v + 0.2,
  },
  {
    ...
    activeDescription: "+0.5 coins/sec",
    cost: 30,
    tick: (v: number) => v + 0.5,
  },
  {
